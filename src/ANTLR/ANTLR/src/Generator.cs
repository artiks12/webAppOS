...
namespace AntlrCSharp
{
    partial class Program
    {
        ...
        {
            bool IsMade = false; // Vai klasē kaut kas ir ģenerēts. Nepieciesams ģenerēšanas stilam.
            ...
            generateConstructor(sw, _class.ClassName, ref IsMade); // Konstruktora ģenerēšana
